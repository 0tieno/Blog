...
4. **Cache**: Responses should clearly declare whether they are cacheable.
5. **Stateless**: The server should not store client session state between requests.
